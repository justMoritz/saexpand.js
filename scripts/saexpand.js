$(function(){   
    ...
    // sets up Object
    var $answerObject = {};
    var $collapsedHeight = "1.25em";
    var $selector = $("[data-expand]");
    ...
    for(i = 0; i < $answerObject.target.length; i++){
        ...
        $($answerObject.target[i]).html("<span>▼</span> " + $answerObject['originalText' + i]);
    }
        ...
        for(i = 0; i < $answerObject.target.length; i++){
            ...
            if($(this).attr("id") == $($answerObject.target[i]).attr("id") ){
                ...
                if($answerObject['expanded' + i] == 0){
                    ...
                    $(this).html("<span>▲</span> " + $answerObject['originalText' + i]);
